...
export type SolverEngine = "cp_sat";
export type OptimalityStatus = "optimal" | "feasible" | "infeasible" | "error";
export type FallbackReason = "timeout" | "unknown" | "infeasible" | "error";
