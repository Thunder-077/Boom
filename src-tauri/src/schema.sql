...
CREATE TABLE IF NOT EXISTS latest_exam_staff_plan_meta (
    ...
    solver_engine TEXT NOT NULL DEFAULT 'cp_sat',
    optimality_status TEXT NOT NULL DEFAULT 'feasible',
...
CREATE TABLE IF NOT EXISTS latest_exam_staff_tasks (
    ...
    recommended_self_study_topic_kind TEXT,
    recommended_self_study_topic_subjects_json TEXT,
    recommended_self_study_topic_label TEXT,
    priority_self_study_chain_json TEXT NOT NULL DEFAULT '[]',
