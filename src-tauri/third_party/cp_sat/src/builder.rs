...
impl CpModelBuilder {
    /// Creates a builder from an existing proto.
    pub fn from_proto(proto: proto::CpModelProto) -> Self {
        Self { proto }
    }

    /// Consumes the builder and returns the underlying proto.
    pub fn into_proto(self) -> proto::CpModelProto {
        self.proto
    }
